...
const images = ["https://fonts.gstatic.com/s/e/notoemoji/latest/1f929/512.gif"];
                    ...
                    <div className="space-y-6">
                      ...
                      >
                        ...
                        <p className="text-lg text-gray-700 dark:text-gray-300">
                          You&apos;ve completed the {topic} lesson and
                          demonstrated a great understanding of HTML concepts.
                      ...
                      >
                        ...
                        <p className="text-lg text-gray-700 dark:text-gray-300">
                          ...
                          Explore more advanced topics and keep building your
