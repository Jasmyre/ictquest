...
//   },
//   {
//     name: "Elements Master Quiz",
//     description: "Challenge yourself with HTML elements",
//   },
            ...
            <div className="px-4 py-8 sm:px-0">
              <div className="mb-16 grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                {/* <Card className="border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <CardContent>
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
                      Test your HTML knowledge with our interactive quizzes
                    </p>
                    ...
                    <div className="mt-6">
                      <Link href="/quizzes">
                        <Button
                          variant="outline"
                          className="w-full border border-indigo-200 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 dark:border-indigo-800 dark:bg-indigo-900/50 dark:text-indigo-300 dark:hover:bg-indigo-900"
                        >
                          Take a Quiz
                          <ArrowRight className="ml-2 h-4 w-4" />
                        </Button>
