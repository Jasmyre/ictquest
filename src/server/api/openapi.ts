...
/**
 * Public OpenAPI document (Migration 18, #41 / ADR 0005).
 *
 ...
 * handler; this static contract document may be cached briefly.
 */
...
export function buildOpenApiDocument(baseUrl: string) {
  return generateOpenApiDocument(appRouter, {
    title: "ICTQuest API",
    description:
      "Versioned REST for me, progress, and achievements. Bearer PAT or cookie auth; batch tRPC stays cookie-only.",
    version: "v1",
    baseUrl,
    tags: ["me"],
    securitySchemes: {
