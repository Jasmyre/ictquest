 ...
 * `proxy.ts` guard.
 *
 * Cache Components: static shell prerenders; the per-request content
 * listing streams in via Suspense.
 */
export default function AdminLessonsPage() {
  return (
    <div
      className="w-full min-w-0 flex-1 p-4 lg:px-8"
      data-testid="admin-lessons"
    >
      ...
      <Suspense fallback={<p>Loading lesson content…</p>}>
