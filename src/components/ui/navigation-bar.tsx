...
export function NavigationBar({
	...
	return (
		<>
			...
			{/* Desktop Navigation */}
			<header
				className={`fixed top-0 right-0 left-0 z-50 mx-auto border-gray-300 border-b bg-card transition-transform duration-300 ease-in-out dark:border-muted ${
					...
					<div className="flex h-14 items-center justify-between px-4">
						...
						<div className="flex items-center space-x-6">
							...
							<NavigationMenu className="relative">
														...
														<div className="grid w-[400px] gap-2 p-4">
															<div className="row-span-3">
																<NavigationMenuLink asChild>
																	<Link
																		className="flex h-full w-full cursor-pointer select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline opacity-90 outline-none transition-all duration-300 hover:opacity-100 focus:shadow-md"
																		href={item.href ?? "#"}
																	>
								...
								<NavigationMenuViewport className="data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full origin-top-center overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-lg data-[state=closed]:animate-out data-[state=open]:animate-in md:w-[var(--radix-navigation-menu-viewport-width)]" />
							</NavigationMenu>
						</div>
			...
			>
				...
				{/* Mobile Breadcrumbs */}
				{pathname !== "/" && (
					<div className="border-gray-300 border-t border-b bg-card px-4 py-2 dark:border-gray-500">
						<Breadcrumb>
							<BreadcrumbList>
